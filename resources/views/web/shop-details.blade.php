...
@section('content')
@if($errors->get('plantReview'))
        <input id="plantReviewError" type="hidden" value="{{$errors}}" >
        <!-- Modal -->
                        <div class="modal fade" id="plantReviewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                ...
                                @foreach($errors->get('plantReview') as $error)
                ...
                <script>
                    $(document).ready(function(){
                        $('#plantReviewError').val(function(){
                            $('#plantReviewModal').modal('show');
                        })
                    })
                </script>
@endif
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('shop.plants') }}">Plants</a></li>
    ...
    <form method="post" action="{{ route('plantToCart') }}">
        @csrf
                ...
                <div class="row justify-content-between">
                                ...
                                <div class="carousel-inner">
                                    <div style="height:450px;" class="carousel-item active">
                                        <!-- <a class="product-img" href="img/bg-img/49.jpg" title="Product Image"> -->
                                            <input name="plant_id" type="hidden" value="{{$shop->id}}" >
                                            <input name="amount" type="hidden" value="{{$shop->price}}" >
                                        <img style="object-fit:contain;width:100%;height:100%" class="d-block product_img" src="{{asset($shop->image)}}" alt="1">
                                    </a>
                                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            ...
                            <h4 class="price"><span >$ </span>{{$shop->price}}</h4>
                            ...
                            <div class="products--meta">
                                ...
                                <p><span>Category:</span><span>{{$shop->categories->categories}}</span></p>
...
// })
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="reviews">
                                ...
                                <div class="submit_a_review_area mt-50">
                                    ...
                                    <form action="{{route('plantReviews')}}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
    ...
    <div class="related-products-area">
        <div class="container">
            ...
            @foreach($recent as $recent_plants)
                <!-- Single Product Area -->
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-100">
                        <!-- Product Image -->
                        <div class="product-img">
                            <a href="shop-details.html"><img src="{{asset($recent_plants->image)}}" alt=""></a>
                            <!-- Product Tag -->
                            ...
                            <div class="product-meta d-flex">
                                ...
                                <a class="add-to-cart-btn">{{$recent_plants->name}}</a>
                                <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                            </div>
                        </div>
                        <!-- Product Info -->
                        <div class="product-info mt-15 text-center">
                            <a href="{{ route('plantDetails',$recent_plants->id) }}">
                                <p>ADD TO CART</p>
                            </a>
                            <h6>{{$recent_plants->price}}</h6>
                        </div>
                    </div>
                </div>
            @endforeach
