...
<style>
    ...
    .input-error{
        border: 1px solid #e61d47 !important;
    }
    .input-okay{
        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url('web/img/bg-img/1.jpg');"></div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center">
                                ...
                                <p>Elevate your space with our expert plant selection and planting services. Our horticultural expertise brings nature's beauty right to your doorstep, creating thriving and captivating landscapes.</p>
                                <div class="welcome-btn-group">
                                    <a href="{{ route('shop.plants') }}" class="btn alazea-btn mr-30">GET STARTED</a>
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url('web/img/bg-img/2.jpg');"></div>
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <!-- Post Content -->
                            <div class="hero-slides-content text-center">
                                <h2>Plants exist in the weather and light rays that surround them</h2>
                                <p>Discover the art of planting with us. Our curated plant collection and skilled planting services transform ordinary spaces into lush, vibrant havens, connecting you with the wonders of nature.</p>
                                <div class="welcome-btn-group">
                                <a href="{{ route('shop.plants') }}" class="btn alazea-btn mr-30">GET STARTED</a>
                                    <a href="{{ route('contact') }}" class="btn alazea-btn active">CONTACT US</a>
                                </div>
            ...
            <div class="row justify-content-between">
                    ...
                    <div class="alazea-service-area mb-100">
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <div class="service-icon mr-30">
                                <img src="{{asset('web/img/core-img/s1.png')}}" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                                <h5>Plants Care</h5>
                                <p>Nurture your plants with regular watering, ensuring they receive the right amount of sunlight for their species.</p>
                            </div>
                        </div>
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                            <!-- Icon -->
                            <div class="service-icon mr-30">
                                <img src="{{asset('web/img/core-img/s2.png')}}" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                                <h5>Pressure Washing</h5>
                                <p>Revitalize plants through gentle pressure washing, removing dirt and grime to reveal their natural beauty.</p>
                            </div>
                        </div>
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="500ms">
                            <!-- Icon -->
                            <div class="service-icon mr-30">
                                <img src="{{asset('web/img/core-img/s3.png')}}" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                                <h5>Tree Service &amp; Trimming</h5>
                                <p>Expert tree service and precise trimming for healthier, safer, and more beautiful plants.</p>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="alazea-video-area bg-overlay mb-100">
                        <img src="{{asset('web/img/bg-img/23.jpg')}}" alt="">
                        <a href="https://www.youtube.com/watch?v=zJYdOLvJnxE" class="video-icon">
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-12 col-lg-5">
                    ...
                    <p>Welcome to Plant Nest, your online haven for green companionship. Explore a curated collection of exquisite plants to enrich your space with nature's beauty and tranquility.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="{{asset('web/img/core-img/b1.png')}}" alt="">
                                    <h5>Quality Products</h5>
                                    <p>Discover unparalleled plant quality that transforms spaces into thriving havens of natural elegance.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="{{asset('web/img/core-img/b2.png')}}" alt="">
                                    <h5>Perfect Service</h5>
                                    <p>Experience plant-perfect service that nurtures your green companionship journey.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="{{asset('web/img/core-img/b3.png')}}" alt="">
                                    <h5>100% Natural</h5>
                                    <p>Embrace nature with our 100% natural plants, bringing pure beauty to your space.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="{{asset('web/img/core-img/b4.png')}}" alt="">
                                    <h5>Environmentally friendly</h5>
                                    <p>Explore our range of eco-friendly plants, where beauty meets sustainability.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row alazea-portfolio">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden design wow fadeInUp" data-wow-delay="300ms">
                    <!-- Portfolio Thumbnail -->
                    <div class="portfolio-thumbnail bg-img" style="background-image: url('web/img/bg-img/18.jpg');"></div>
                    <!-- Portfolio Hover Text -->
                    <div class="portfolio-hover-overlay">
                    ...
                    <div class="testimonials-slides owl-carousel"> -->
                            ...
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6">
                                    <div class="testimonial-thumb">
                                        <img src="{{asset('web/img/bg-img/13.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                        ...
                        <!-- <div class="single-testimonial-slide">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6">
                                    <div class="testimonial-thumb">
                                        <img src="{{asset('web/img/bg-img/14.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="testimonial-content">
                        ...
                        <!-- <div class="single-testimonial-slide">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6">
                                    <div class="testimonial-thumb">
                                        <img src="{{asset('web/img/bg-img/15.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="testimonial-content">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="product-img">
                            <a href="{{ route('plantDetails',$arrivals->id) }}" ><img src="{{asset($arrivals->image)}}" alt=""></a>
                            <!-- Product Tag -->
                            ...
                            <div class="product-meta d-flex justify-content-center">
                                ...
                                <a href="" class="add-to-cart-btn">{{$arrivals->name}}</</a>
                                <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                            </div>
                        </div>
                        <!-- Product Info -->
                        <div class="product-info mt-15 text-center">
                            <a  href="{{ route('plantDetails',$arrivals->id) }}">
                                <p>ADD TO CART</p>
                            </a>
                            <h6>$ {{$arrivals->price}}</h6>
                        </div>
                    </div>
                </div>
@endforeach
                <div class="col-12 text-center">
                    <a href="{{ route('shop.plants') }}" class="btn alazea-btn">View All</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-post mb-100">
                        <div class="post-thumbnail mb-30">
                            <a href="single-post.html"><img src="{{asset('web/img/bg-img/6.jpg')}}" alt=""></a>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-post mb-100">
                        <div class="post-thumbnail mb-30">
                            <a href="single-post.html"><img src="{{asset('web/img/bg-img/7.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-content">
                            <a href="single-post.html" class="post-title">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-post mb-100">
                        <div class="post-thumbnail mb-30">
                            <a href="single-post.html"><img src="{{asset('web/img/bg-img/8.jpg')}}" alt=""></a>
                        </div>
                        <div class="post-content">
                            <a href="single-post.html" class="post-title">
    ...
    <section class="subscribe-newsletter-area" style="">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-lg-6">
                    <div class="subscribe-form">
                        <form id="subscription-form" action="#" method="get">
                            <input type="email" name="subscribe-email" id="subscribeEmail" placeholder="Enter your email">
                            <button id="subscription-btn" type="submit" class="btn alazea-btn">SUBSCRIBE</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="subscribe-side-thumb wow fadeInUp" data-wow-delay="500ms">
            <img class="first-img" src="{{asset('web/img/core-img/leaf.png')}}" alt="">
        </div>
    </section>
    <!-- ##### Subscribe Area End ##### -->
            ...
            $(document).ready(function(){
                $('#subscribeEmail').keyup(function(){
                    ...
                    if (!emailPattern.test(email)) {
                        $('#subscribeEmail').removeClass('input-okay');
                        $('#subscribeEmail').addClass('input-error');
                    }
                    else{
                        $('#subscribeEmail').removeClass('input-error');
                        $('#subscribeEmail').addClass('input-okay');
