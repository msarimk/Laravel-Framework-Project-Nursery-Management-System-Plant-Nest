                    ...
                    <div class="shop-sidebar-area">
                        ...
                        <div class="shop-widget best-seller mb-50">
                            ...
                            <div class="widget-desc">
                                ...
                                <div class="single-best-seller-product d-flex align-items-center">
                                    <div class="product-thumbnail">
                                        <a href=""><img src="{{asset('web/img/bg-img/34.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="product-info">
                                        <a href="">Recuerdos Plant</a>
                                        <p>$9.99</p>
                                        <div class="ratings">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href=""><img src="{{asset($plant->image)}}" alt=""></a>
                                        ...
                                        <div class="product-meta d-flex">
                                            ...
                                            <a href="{{ route('plantDetails',$plant->id) }}" class="add-to-cart-btn">{{$plant->name}}</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                                        </div>
                                    </div>
                  
                                    <div class="product-info mt-15 text-center">
                                        <a href="{{ route('plantDetails',$plant->id) }}">
                                            <p>ADD TO CART</p>
                                        </a>
                                        <h6>$ {{$plant->price}}</h6>
                                    </div>
                        ...
                        @endforeach
                            ...
                            <!-- <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a ><img src="{{asset('web/img/bg-img/41.png')}}" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href=""><img src="{{asset('web/img/bg-img/42.png')}}" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="{{asset('web/img/bg-img/43.png')}}" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="{{asset('web/img/bg-img/44.png')}}" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="{{asset('web/img/bg-img/45.png')}}" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="{{asset('web/img/bg-img/46.png')}}" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="{{asset('web/img/bg-img/47.png')}}" alt=""></a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="{{asset('web/img/bg-img/48.png')}}" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
