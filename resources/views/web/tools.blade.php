                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tools & Accessories</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href=""><img style="height:300px" src="{{asset($tool->image)}}" alt=""></a>
                                        ...
                                        <div class="product-meta d-flex">
                                            ...
                                            <a href="cart.html" class="add-to-cart-btn">{{$tool->name}}</a>
                                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
                                        </div>
                                    </div>
                                    <div class="product-info mt-15 text-center">
                                        <a href="{{ route('toolDetails',$tool->id) }}">
                                            <p>ADD TO CART</p>
                                        </a>
                                        <h6>{{$tool->price}}</h6>
                                    </div>
